...
export default function Contact() {
  ...
  return (
    <section className="min-h-screen pt-32 pb-20 px-6">
          ...
          <div className="fade-up">
            ...
            <div className="mt-12 pt-8 border-t border-ark-border">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 border border-ark-border rounded-lg flex items-center justify-center hover:border-ark-accent hover:text-ark-accent transition-colors">
          ...
          <div>
            {!submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        name="name"
                        required
                        className="w-full px-4 py-3 rounded-lg bg-ark-gray border border-ark-border text-ark-white focus:border-ark-accent focus:outline-none focus:ring-3 focus:ring-ark-accent/10"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      required
                      className="w-full px-4 py-3 rounded-lg bg-ark-gray border border-ark-border text-ark-white resize-none focus:border-ark-accent focus:outline-none focus:ring-3 focus:ring-ark-accent/10"
              ...
              <div className="gradient-border rounded-2xl p-8 md:p-12 text-center">
                ...
                <Link href="/" className="inline-flex items-center gap-2 text-ark-accent font-medium hover:gap-3 transition-all">
                  Back to home
      ...
      {/* FAQ */}
      <section className="py-24 px-6 border-t border-ark-border mt-24">
        <div className="max-w-7xl mx-auto">
